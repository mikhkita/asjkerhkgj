...
//            );?>
            ...
            if($cheapest_item["PRICES"][$arResult["CUR_PRICE_CODE"]]["DISCOUNT_VALUE_VAT"] != $cheapest_item["PRICES"][$arResult["CUR_PRICE_CODE"]]["VALUE_VAT"]){
                ?><span id="sum" class="discount" style="font-size: 20px"><?=ceil($cheapest_item["PRICES"][$arResult["CUR_PRICE_CODE"]]["DISCOUNT_VALUE_VAT"])?> руб.</span>
                <span id="old-price" class="old-price" style="font-size: 20px"><?=ceil($cheapest_item["PRICES"][$arResult["CUR_PRICE_CODE"]]["VALUE_VAT"])?> руб.</span><?
            }
            else{
