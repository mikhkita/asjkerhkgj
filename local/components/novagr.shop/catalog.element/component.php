...
//            pre($item["PROPERTIES"]["MORE_PHOTO"]["VALUE"]);
...
//                    $arFileTmp = Novagroup_Classes_General_Main::MakeResizePicture($item["DETAIL_PICTURE"],array('WIDTH'=>'86', 'HEIGHT'=>'114'));
...
//                );
//
//                $arResult["ELEMENT_MORE_PHOTO_MIDDLE"][$item['PREVIEW_PICTURE']] = $arFileTmp;
//
...
//                    $arResult["ELEMENT_MORE_PHOTO"][$item['PREVIEW_PICTURE']] = $FILE;
//                }
//
//                $arFileTmp = MakeResizePicture($item['PREVIEW_PICTURE'],array('WIDTH'=>'86', 'HEIGHT'=>'114'));
//                $arResult['PREVIEW_PICTURE'][$item['PREVIEW_PICTURE']] = $arFileTmp["src"];
//            }
