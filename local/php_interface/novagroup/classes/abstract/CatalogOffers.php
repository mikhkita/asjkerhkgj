...
abstract class Novagroup_Classes_Abstract_CatalogOffers extends Novagroup_Classes_Abstract_Catalog
{
     ...
     function getFilterRows()
    {
		if(
            ...
            ||
            isset($this->arParams['arFilterRequest']['PROPERTY_SALE_VALUE'])
            ||
            isset($this->arParams['arFilterRequest']['PROPERTY_SALE_LEADER_VALUE'])
            ||
            isset($this->arParams['arFilterRequest']['PROPERTY_LAST_SIZE_VALUE'])
            ||
            isset($this->arParams['arFilterRequest']['PROPERTY_NEW_VALUE'])
            ||
            isset($this->arParams['arFilterRequest']['PROPERTY_OFFER_VALUE'])
            ||
            isset($this->arParams['arFilterRequest']['PROPERTY_DISCOUNTED_VALUE'])
        )
        {
        ...
        if( isset($this->arParams['arFilterRequest']['PROPERTY_SALE_VALUE']) )
        {
            $arSpecial[0]['PROPERTY_SALE_VALUE'] = $this->arParams['arFilterRequest']['PROPERTY_SALE_VALUE'][0];
            unset($this->arParams['arFilterRequest']['PROPERTY_SALE_VALUE']);
        }
        if( isset($this->arParams['arFilterRequest']['PROPERTY_SALE_LEADER_VALUE']) )
        {
            $arSpecial[0]['PROPERTY_SALE_LEADER_VALUE'] = $this->arParams['arFilterRequest']['PROPERTY_SALE_LEADER_VALUE'][0];
            unset($this->arParams['arFilterRequest']['PROPERTY_SALE_LEADER_VALUE']);
        }
        if( isset($this->arParams['arFilterRequest']['PROPERTY_LAST_SIZE_VALUE']) )
        {
            $arSpecial[0]['PROPERTY_LAST_SIZE_VALUE'] = $this->arParams['arFilterRequest']['PROPERTY_LAST_SIZE_VALUE'][0];
            unset($this->arParams['arFilterRequest']['PROPERTY_LAST_SIZE_VALUE']);
        }
        if( isset($this->arParams['arFilterRequest']['PROPERTY_NEW_VALUE']) )
        {
            $arSpecial[0]['PROPERTY_NEW_VALUE'] = $this->arParams['arFilterRequest']['PROPERTY_NEW_VALUE'][0];
            unset($this->arParams['arFilterRequest']['PROPERTY_NEW_VALUE']);
        }
        if( isset($this->arParams['arFilterRequest']['PROPERTY_OFFER_VALUE']) )
        {
            $arSpecial[0]['PROPERTY_OFFER_VALUE'] = $this->arParams['arFilterRequest']['PROPERTY_OFFER_VALUE'][0];
            unset($this->arParams['arFilterRequest']['PROPERTY_OFFER_VALUE']);
        }
        if( isset($this->arParams['arFilterRequest']['PROPERTY_OFFER_VALUE']) )
        {
            $arSpecial[0]['PROPERTY_DISCOUNTED_VALUE'] = $this->arParams['arFilterRequest']['PROPERTY_DISCOUNTED_VALUE'][0];
            unset($this->arParams['arFilterRequest']['PROPERTY_DISCOUNTED_VALUE']);
        }
