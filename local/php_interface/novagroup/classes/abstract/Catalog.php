...
abstract class Novagroup_Classes_Abstract_Catalog extends Novagroup_Classes_Abstract_IBlock
{
    ...
    protected $catalogPath = "/catalog/", $catalogName = "Каталог", $catalogIBlockCode = "products";

    function getCatalogPath()
    {
        return str_replace('/', SITE_DIR, $this->catalogPath);
    }
...
//        Novagroup_Classes_General_Main::setTitle($this->getCatalogName());
        Novagroup_Classes_General_Main::setTitle("Каталог");
    }
